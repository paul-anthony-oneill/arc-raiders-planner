...
const Planner: React.FC<PlannerProps> = ({ selectedItem, onBack }) => {
    ...
    return (
        <div className="planner-container" style={{ maxWidth: '1200px', margin: '0 auto', fontFamily: 'sans-serif', padding: '20px' }}>
            <button onClick={onBack} style={{ marginBottom: '20px', padding: '10px 20px', cursor: 'pointer', fontSize: '16px' }}>
            ...
            <div style={{
                ...
                <div style={{ marginBottom: '15px' }}>
                    ...
                    <p style={{ marginLeft: '28px', marginTop: '5px', fontSize: '14px', color: '#666' }}>
                ...
                <div style={{ marginBottom: '15px' }}>
                    ...
                    >
                        <option value="PURE_SCAVENGER">🔍 Pure Scavenger - Most Loot Zones</option>
                        <option value="EASY_EXFIL" disabled={!hasRaiderKey}>
                            🚪 Easy Exfil - Near Raider Hatches {!hasRaiderKey && '(Requires Key)'}
                        </option>
                        <option value="AVOID_PVP">🛡️ Avoid PvP - Safe from Players</option>
                        <option value="SAFE_EXFIL" disabled={!hasRaiderKey}>
                            ✅ Safe Exfil - Safe Route + Close Exit {!hasRaiderKey && '(Requires Key)'}
                        </option>
                    </select>
