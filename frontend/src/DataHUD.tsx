...
const MODE_DESCRIPTIONS: Record<RoutingProfile, string> = {
    [RoutingProfile.PURE_SCAVENGER]: "PROTOCOL: MAX_YIELD. Ignores distance constraints. Targets maximum loot density across all sectors.",
    [RoutingProfile.EASY_EXFIL]: "PROTOCOL: FAST_EXIT. Prioritizes loot clusters in close proximity to operational Raider Hatches.",
    [RoutingProfile.AVOID_PVP]: "PROTOCOL: STEALTH. Routes through low-traffic sectors. Avoids High-Tier zones. Penalizes open ground.",
    [RoutingProfile.SAFE_EXFIL]: "PROTOCOL: HYBRID. Balances stealth routing with hatch proximity. The recommended setting for solo operatives."
};

const DataHUD: React.FC<DataHUDProps> = ({ stats, activeProfile, hoveredProfile }) => {
